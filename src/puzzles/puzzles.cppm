    ...
    switch (spec.year) {
      case 2015:
        ...
        switch (spec.day) {
          ...
          case 5:
            if (spec.part == 1 || spec.part == 0) {
              answers[0] = y2015::d05::part1(arena, rawR.value);
            }
            if (spec.part == 2 || spec.part == 0) {
              answers[1] = y2015::d05::part2(arena, rawR.value);
            }
          break;

          case 6:
            if (spec.part == 1 || spec.part == 0) {
              answers[0] = y2015::d06::part1(arena, rawR.value);
            }
            if (spec.part == 2 || spec.part == 0) {
          ...
          case 9:
            if (spec.part == 1 || spec.part == 0) {
              answers[0] = y2015::d09::part1(arena, rawR.value);
            }
            if (spec.part == 2 || spec.part == 0) {
              answers[1] = y2015::d09::part2(arena, rawR.value);
            }
          break;
